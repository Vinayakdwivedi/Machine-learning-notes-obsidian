...
This formula is good when the mean line of the model passes through 
center, but to make the model flexible we introduce a bias term which gives our model flexibility along y axis. So now our equation looks like this-
